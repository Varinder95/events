               ...
               <div class="row">
                  ...
                  <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                     <div class="footer-widget f-w2 mb-40">
                        ...
                        <ul>
                           <li><NuxtLink href="#">Proper Guidelines</NuxtLink></li>
                           <li><NuxtLink href="#">Digital Library</NuxtLink></li>
                           <li><NuxtLink href="#">Compare Us</NuxtLink></li>
                           <li><NuxtLink href="#">Become Instructor</NuxtLink></li>
                           <li><NuxtLink href="#">Build Career</NuxtLink></li>
                        </ul>
                     </div>
                  </div>
                  <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                     <div class="footer-widget f-w3 mb-40">
                        ...
                        <ul>
                           <li><NuxtLink href="#">Development</NuxtLink></li>
                           <li><NuxtLink href="#">Business</NuxtLink></li>
                           <li><NuxtLink href="#">Health & Fitness</NuxtLink></li>
                           <li><NuxtLink href="#">Life Styles</NuxtLink></li>
                           <li><NuxtLink href="#">Photography</NuxtLink></li>
                        </ul>
                     </div>
                  </div>
                  <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                     <div class="footer-widget f-w4 mb-40">
                        ...
                        <ul>
                           ...
                           <li><NuxtLink href="#">Forum</NuxtLink></li>
                           <li><NuxtLink to="/contact">Help & Support</NuxtLink></li>
                           <li><NuxtLink href="#">Community</NuxtLink></li>
                           <li><NuxtLink href="#">Documentation</NuxtLink></li>
                        </ul>
                     </div>
                  </div>
               </div>
